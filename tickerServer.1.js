...
io.sockets.on('connection',function(socket){
  ...
  socket.interval = setInterval(() => {
    ...
    var prodList2 = [{"timestamp":"2015-01-12T17:22:40.4372664+11:00","capcode":"0012345","parsedname":"NAME","message":"THIS IS A TEST MESSAGE"}];
    for (let i = 0; i < 5; i++) {
      prodList2.push(Mock.mock({
        "timestamp":'@float(0, 100, 2, 2)',
        "capcode":'@float(0, 100, 2, 2)',
        "parsedname":'@float(0, 100, 2, 2)',
        "message":'@float(0, 100, 2, 2)',
      }))
  }

    
    socket.emit('prodList2',prodList2);
